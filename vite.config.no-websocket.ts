...
// Alternative configuration that completely disables WebSocket connections
// Use this if you continue experiencing WebSocket connection issues
// To use: rename this file to vite.config.ts and restart the dev server
...
export default defineConfig({
  ...
  // Configurações de servidor para desenvolvimento - SEM WEBSOCKET
  server: {
    fs: {
      strict: false
    },
    ...
    // DESABILITAR COMPLETAMENTE HMR E WEBSOCKET
    ...
    watch: {
      usePolling: true, // Usar polling em vez de eventos do sistema
      interval: 1000, // Verificar mudanças a cada segundo
